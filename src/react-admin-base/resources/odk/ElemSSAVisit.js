...
export const ElemSSAVisitList = (props) => (
  ...
  >
    <Datagrid>
      ...
      <TextField label='' source='data[0].uniform' />
      <TextField label='' source='data[0].textbook' />
      ...
      <TextField label='' source='data[0].clean_staff' />
      ...
      <TextField label='' source='data[0].bagless_yn' />
      <TextField label='' source='data[0].bagless_locker' />
      ...
      <TextField label='' source='data[0].swings' />
      <TextField label='' source='data[0].ell_training' />
      ...
      <TextField label='' source='data[0].civil_requested' />
