  ...
  return (
    <div style={{ width: 300 }}>
      <Autocomplete
        ...
        debug
        renderInput={(params) => (
          <TextField {...params} label='debug' margin='normal' fullWidth />
        )}
      />
      <Autocomplete
        {...defaultProps}
      ...
      <Autocomplete
        ...
        id='flat-demo'
        renderInput={(params) => (
          <TextField {...params} label='flat' margin='normal' fullWidth />
        )}
      />
      <Autocomplete
        {...defaultProps}
      ...
      <Autocomplete
        ...
        disabled
        renderInput={(params) => (
          <TextField {...params} label='disabled' margin='normal' fullWidth />
        )}
      />
      <Autocomplete
        {...defaultProps}
